...
class IMP implements MouseListener {
    ...
    * for handling the choice, fun1, fun2, fun3, fun4, etc. etc. 
    ...
    private JMenu getFunctions() {
        ...
        JMenuItem seventhItem = new JMenuItem("Equilize Histogram");
   ...
   ************************************************************************************************
    ...
    * integer value so you can give it back to the program and display the new picture. 
    ...
    private void colorHistogram() {
        ...
        greenFrame.setLocation(900, 0);
        JFrame blueFrame = new JFrame("blue");
        blueFrame.setSize(305, 600);
        blueFrame.setLocation(1200, 0);
        redPanel = new MyPanel(redArray, factor);
        greenPanel = new MyPanel(greenArray, factor);
        bluePanel = new MyPanel(blueArray, factor);
    ...
    public void equalizeHistogram() {
        ...
        double blueProbability[] = new double[256];
        for (int i = 0; i < 256; i++) {
            redpix=redArray[i]+redpix;
            greenpix=greenArray[i]+greenpix;
            bluepix=blueArray[i]+bluepix;

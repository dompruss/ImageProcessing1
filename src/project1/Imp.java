...
private void edgeDetect()
  {
    ...
    for(int i=1; i<height-1; i++)
       ...
       {   
           ...
           rgbArray[1]= (((-8*rgbArray[1])+zero[1]+one[1]+two[1]+three[1]+four[1]+five[1]+six[1]+seven[1])/9) ;
           rgbArray[2]= rgbArray[1];
           rgbArray[3]= rgbArray[1];
...
private void colorHistogram()
  {
   ...
   for(int i =0; i<256;i++){
       if(redMin == 0  && redArray[i] !=0 ){
           redMin = redArray[i]; // this will be looking for the smallest red value
       }
       if(greenMin == 0  &&  greenArray[i] !=0 ){
           greenMin = greenArray[i]; // this will be looking for the min green
       }
       if(blueMin == 0  && blueArray[i] !=0 ){
           blueMin = blueArray[i]; // this will be looking for the max
       }
